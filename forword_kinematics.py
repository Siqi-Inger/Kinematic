...
sys.path.append('home/assignment1/src/')
...
class ForwardKinematics(Node):
    ...
    def _set_pose_target(self, user_input):
        ...
        for i, value in enumerate(user_input.split()[:7]):
            ...
            # slipt the user input based on the order
            if i < 3:
